...
import { Calendar, Eye, EyeOff, Check } from "lucide-react"
                ...
                <div className="glass rounded-2xl p-8">
                    ...
                    <div className="relative mb-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-4 bg-slate-800 text-slate-400">or register with email</span>
                        </div>
                    </div>
                        ...
                        <div className="space-y-2">
                            {passwordRequirements.map((req, i) => (
                                <div key={i} className="flex items-center gap-2 text-sm">
                                    <div className={`w-4 h-4 rounded-full flex items-center justify-center ${req.met ? "bg-emerald-500" : "bg-slate-700"
                                        }`}>
